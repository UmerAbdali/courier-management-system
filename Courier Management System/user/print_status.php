...
<title>Print Status - Logistics Transport</title>
...
<div class="print-container">
    <div class="print-card">
        <h2><i class="fa-solid fa-print"></i> Print Status</h2>
        <p>Print your shipment status and tracking details</p>
        <form method="post" action="#">
            ...
            <button class="print-btn" type="submit"><i class="fa-solid fa-print"></i> Print Status</button>
        </form>
    </div>
</div>
