...
<title>Admin Portal - Logistics Transport</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="menu">
            ...
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="#">Couriers</a></li>
                <li class="nav-item"><a class="nav-link" href="shipment_history.php"> Shipment History</a></li>
